...
class Qenta_CheckoutSeamless_Block_Additional_Invoice extends Mage_Core_Block_Template
{

    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qenta/checkoutseamless/additional/invoice.phtml');
    }
