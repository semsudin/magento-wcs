...
class Qenta_CheckoutSeamless_Block_Additional_InvoiceB2b extends Mage_Core_Block_Template
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('qenta/checkoutseamless/additional/invoiceb2b.phtml');
    }
