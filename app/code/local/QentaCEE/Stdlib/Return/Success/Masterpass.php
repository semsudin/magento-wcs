...
/**
 * @name QentaCEE_Stdlib_Return_Success_Masterpass
 * @category QentaCEE
 * @package QentaCEE_Stdlib
 * @subpackage Return_Success
 * @abstract
 */
abstract class QentaCEE_Stdlib_Return_Success_Masterpass extends QentaCEE_Stdlib_Return_Success_CreditCard
{
    /**
