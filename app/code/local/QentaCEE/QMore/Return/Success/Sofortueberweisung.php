...
/**
 * @name QentaCEE_QMore_Return_Success_PayPal
 * @category QentaCEE
 * @package QentaCEE_QMore
 * @subpackage Return_Success
 */
class QentaCEE_QMore_Return_Success_Sofortueberweisung extends QentaCEE_Stdlib_Return_Success_Sofortueberweisung
{
